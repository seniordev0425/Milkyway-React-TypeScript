...
import './createpromotiontask.scss';
...
const CreatePromotionTask: React.FC = () => {
    ...
    const handleClickCreateTask = async () => {
        ...
        if (taskCreateResult.data.taskId) {
            history.push(`/promotiontask/${taskCreateResult.data.taskId}`);
            return;
        }
        setCreateTaskLoading(false);
    }
        ...
        <div className="createtask">
            <div className="createtask__content">
                ...
                </div>
                {
                    (userRole === 'headquarter') ?
                        <div className="createtask__content__item">
                            <div className="createtask__content__item--time">
                                <div className="createtask__content__item--starttime">
                                    <div className="createtask__content__item__title">
                                        Start time ({getCurrentTimeZone()})
                                    </div>
                                    <div className="createtask__content__item__content">
                                        <DatePicker
                                            selected={taskStartDay}
                                            onChange={(date: any) => setTaskStartDay(date)}
                                            showTimeSelect
                                            timeFormat="HH:mm"
                                            timeIntervals={15}
                                            timeCaption="time"
                                ...
                                <div className="createtask__content__item--endtime">
                                    <div className="createtask__content__item__title">
                                    ...
                                    <div className="createtask__content__item__content">
                                        <DatePicker
                                            selected={taskEndDay}
                                            onChange={(date: any) => setTaskEndDay(date)}
                                            showTimeSelect
                                            timeFormat="HH:mm"
                                            timeIntervals={15}
                                            timeCaption="time"
                    ...
                    <div className="createtask__cta">
                        {
                            (createTaskLoading) ?
                                ...
                                <Button
                                    ...
                                    buttonText="Create a promotion task"
                                />
                        }
                    </div>
                </div>
...
export default CreatePromotionTask;
